...
//   if (hs.api.connection){
//     hs.api.connection.send('would senmd');
//   } else {
//     hs.api.connection = new hs.api.Connection();
//     hs.api.connection.bind('connected', function(){
...
//         if (jqXHR.status == 0){
//           options.clbk(jqXHR.statusText, jqXHR.status);
//         }else{
